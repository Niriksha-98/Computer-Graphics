...
glPushMatrix();
glColor3f(1,1,0);
output(200,550,"B.N.M. INSTITUTE OF TECHNOLOGY",2);
...
output(115,180,"Smt.Ranjana S Chakrasali",2);
output(115,150,"Smt.Usha C.R",2);
output(460,200,"By:",5);
output(485,180,"NIRIKSHA N",2);
output(485,150,"1BG16CS069",2);
